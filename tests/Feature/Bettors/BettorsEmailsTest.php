...
class BettorsEmailsTest extends TestCase
{
    ...
    public function test_the_resend_of_the_mail_invitation(): void
    {
        ...
        $this->actingAs($user);
        $response = $this->postJson($this->getEndPoint() . "bets/$bet->id/bettors/$bettor->id/resend-email-invitation")->dump();
        $response->assertStatus(200);
    ...
    public function test_the_resend_of_the_mail_invitation_is_limited_for_a_day(): void
    {
        ...
        $this->actingAs($user);
        $response = $this->postJson($this->getEndPoint() . "bets/$bet->id/bettors/$bettorToResend->id/resend-email-invitation")->dump();
